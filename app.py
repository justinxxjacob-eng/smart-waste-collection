        ...
        if residents:
            ...
            for r in residents:
                ...
                if last_log:
                    ...
                    waste_volume = estimate_waste_volume(bin_count, bin_type, fill_level) if bin_count > 0 else 0
                else:
                    last_status = '— No data'
                    last_collected = ''
                    waste_volume = 0
